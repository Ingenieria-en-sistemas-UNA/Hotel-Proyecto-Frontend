...
class EnhancedTable extends Component {
  ...
  render() {
    const { classes, rows, title, handlerChangeFilter } = this.props
    const { data, order, orderBy, selected, rowsPerPage, page } = this.state
    const emptyRows = rowsPerPage - Math.min(rowsPerPage, data.length - page * rowsPerPage)
    return (
      <Grid container>
        <Paper className={classes.root}>
          <EnhancedTableToolbar numSelected={selected.length} title={title} handlerChangeFilter={handlerChangeFilter}/>
                  ...
                  .map(n => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align={'center'}>{n.state ? 'Ocupada' : 'Disponible'}</TableCell>
